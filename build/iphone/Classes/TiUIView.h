...
/**
 Base class for all SocialShare views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the SocialShare view hierarchy (such as wrapped iOS UIViews) was touched.
