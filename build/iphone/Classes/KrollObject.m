...
//@interface SocialShareObject : NSObject
//@end

@interface SocialShareObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SocialShareObject class]])
		{
			for (NSString *key in [[(SocialShareObject*)o modules] allKeys])
			{
