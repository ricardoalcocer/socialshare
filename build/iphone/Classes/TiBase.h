...
// in simulator we redefine to format for SocialShare Developer console
...
{\
	NSString * exceptionName = [@"org.socialshare." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.socialshare";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISocialShareNativeItemNone = -1, 
	UISocialShareNativeItemSpinner = -2,
	UISocialShareNativeItemProgressBar = -3,
	
	UISocialShareNativeItemSlider = -4,
	UISocialShareNativeItemSwitch = -5,
	UISocialShareNativeItemMultiButton = -6,
	UISocialShareNativeItemSegmented = -7,
	
	UISocialShareNativeItemTextView = -8,
	UISocialShareNativeItemTextField = -9,
	UISocialShareNativeItemSearchBar = -10,
	
	UISocialShareNativeItemPicker = -11,
	UISocialShareNativeItemDatePicker = -12,
	
	UISocialShareNativeItemInfoLight = -13,
	UISocialShareNativeItemInfoDark = -14,
	
	UISocialShareNativeItemDisclosure = -15,
	
	UISocialShareNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all SocialShare instances of
