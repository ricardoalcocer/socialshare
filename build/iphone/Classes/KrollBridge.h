...
@interface SocialShareObject : KrollCoverageObject {
#else
@interface SocialShareObject : KrollObject {
#endif
@private
...
extern NSString * SocialShare$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	SocialShareObject *_socialshare;
    KrollObject* console;
	BOOL shutdown;
